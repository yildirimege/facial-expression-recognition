...
model.add(keras.layers.Conv2D(128, (5, 5), input_shape=input_shape, padding='same', activation='relu'))
model.add(keras.layers.MaxPooling2D(pool_size=(2, 2), strides=(2, 2)))
model.add(keras.layers.Dropout(0.25))

model.add(keras.layers.Conv2D(512, (3, 3), input_shape=input_shape, padding='same', activation='relu'))
model.add(keras.layers.MaxPooling2D(pool_size=(2, 2), strides=(2, 2)))
model.add(keras.layers.Dropout(0.25))
...
history = model.fit(X_train, y_train, batch_size=128, epochs=124, verbose=1, validation_data=(X_test, y_test)) #Training the model